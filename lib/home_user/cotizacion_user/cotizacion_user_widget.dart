...
import 'cotizacion_user_model.dart';
export 'cotizacion_user_model.dart';

class CotizacionUserWidget extends StatefulWidget {
  const CotizacionUserWidget({Key? key}) : super(key: key);

  @override
  _CotizacionUserWidgetState createState() => _CotizacionUserWidgetState();
}

class _CotizacionUserWidgetState extends State<CotizacionUserWidget> {
  late CotizacionUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CotizacionUserModel());
