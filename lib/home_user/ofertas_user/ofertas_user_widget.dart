...
export 'ofertas_user_model.dart';

class OfertasUserWidget extends StatefulWidget {
  const OfertasUserWidget({Key? key}) : super(key: key);

  @override
  _OfertasUserWidgetState createState() => _OfertasUserWidgetState();
}

class _OfertasUserWidgetState extends State<OfertasUserWidget> {
  late OfertasUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OfertasUserModel());
                                        ...
                                        child: Container(
                                          ...
                                          child: Align(
                                            alignment: AlignmentDirectional(
                                                0.00, 0.00),
                                            child: Text(
                                              listViewCatalogosRecord.categoria,
