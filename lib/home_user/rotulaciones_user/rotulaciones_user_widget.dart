...
import 'rotulaciones_user_model.dart';
export 'rotulaciones_user_model.dart';

class RotulacionesUserWidget extends StatefulWidget {
  const RotulacionesUserWidget({Key? key}) : super(key: key);

  @override
  _RotulacionesUserWidgetState createState() => _RotulacionesUserWidgetState();
}

class _RotulacionesUserWidgetState extends State<RotulacionesUserWidget> {
  late RotulacionesUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RotulacionesUserModel());
