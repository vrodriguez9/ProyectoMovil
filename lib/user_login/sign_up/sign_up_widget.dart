...
class _SignUpWidgetState extends State<SignUpWidget> {
  ...
  void initState() {
    ...
    _model.txtNombreCompletoController ??= TextEditingController();
    _model.txtNombreCompletoFocusNode ??= FocusNode();
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.txtNombreCompletoController,
                                    focusNode:
                                        _model.txtNombreCompletoFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model
                                        .txtContraseniaControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.txtRepetirContraseniaController,
                                    focusNode:
                                        _model.txtRepetirContraseniaFocusNode,
                                    autofillHints: [AutofillHints.password],
                                    obscureText:
                                        !_model.txtRepetirContraseniaVisibility,
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: InkWell(
                                        onTap: () => setState(
                                          () => _model
                                                  .txtRepetirContraseniaVisibility =
                                              !_model
                                                  .txtRepetirContraseniaVisibility,
                                        ),
                                        focusNode:
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.txtContraseniaController
                                                .text !=
                                            _model
                                                .txtRepetirContraseniaController
                                                .text) {
